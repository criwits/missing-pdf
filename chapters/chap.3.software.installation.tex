...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item[A] 安装 Steam：\verb|C:\Program Files\steam|
    \item[B] 装微信电脑版：\verb|D:\Program Files (x86)\Tencent\Wechat|
    \item[C] 安装 Vivado：\verb|D:\软件\Xilinx\Vivado|
    \item[D]安装网易云音乐：\verb|桌面\我的软件\Cloudmusic|
  \end{enumerate}
