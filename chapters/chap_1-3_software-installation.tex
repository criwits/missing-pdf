...
\begin{note}
  至于那些「绿色版」或「便携版」软件，它们没有「安装」这一过程。要么是单单一个 \MissingVerb{exe} 文件，点开就能用；要么以压缩包形式出现，但是「开箱即用」——解压后直接运行主程序就可以用，就像下面这样。
  \begin{center}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=.55\textwidth]{assets/basic/Change_C_to_D.png}
