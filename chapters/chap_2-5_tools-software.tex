...
GitHub 发布页：\url{https://github.com/valinet/ExplorerPatcher/releases}，一般下载 \MissingVerb{ep_setup.exe} 即可。如果你使用的是 ARM 指令集的 CPU（参见\chapref{cha:software-installation}，详细内容则请见\chapref{cha:program-and-arch}），请下载 \MissingVerb{ep_setup_arm64.exe}。
