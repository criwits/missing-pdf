...
\begin{intro}
  ...
  \begin{itemize}
    ...
    \item 为什么我在网上或一些 app 中，有时会看见各种各样的乱码？例如：
      \begin{itemize}
        \item 浣犵己澶辩殑閭ｉ棬璁＄畻鏈鸿
        \item ä½\symbol{"A0}ç¼ºå¤±çš„é‚£é—¨è®¡ç®—æœºè¯¾
      \end{itemize}
...
\begin{table}[htb!]
  ...
  \begin{tblr}{
    ...
    {\Tibetan དྷ} & \MissingTT{81 32 F0 36} \\
    \bottomrule
  \end{tblr}
\end{table}
